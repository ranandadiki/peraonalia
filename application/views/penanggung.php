        ...
        <div class="col">
            ...
            <center>
                ...
                <div class="p-3 border bg-light position-relative" style="width: 50%;">
                    ...
                    <h3 class="position-absolute top-0 start-50 translate-middle-x">Daftar Data Penanggung</h3>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="table-secondary">
                                        <?php echo $db->Penanggung; ?>
                                    </td>
                                    <td>
                                        <center>
                                            <a href="<?php echo base_url('home/hapusPenanggung/' . $db->id); ?>" onclick="return confirm('Anda yakin hapus ?')"><button type="button" class="btn btn-outline-danger btn-sm">del</button></a>
                                        </center>
                                    </td>
                                </tr>
                            <?php
            ...
            <!-- Modal -->
            <?php echo form_open('home/tambahPenanggung/', ['method' => 'post']); ?>
